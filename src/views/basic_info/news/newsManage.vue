    ...
    <el-row >
        <el-col :span="20" style="margin-top: 25px">
            <el-tabs v-model="activeTabName" @tab-click="handleLevelOneTabClick" tab-position="left" style="height: 100%;">
                ...
                <!--第一个纵向tab进行栏目设置-->
                <el-tab-pane label="栏目设置" name="newsTypeSetting">
                ...
                <el-tab-pane label="文章管理" name="articleManagement">
                    <div style="padding-left: 10px;padding-top: 0;padding-right: 25px;border: 0;border-radius: 10px;">
                        ...
                        <el-tabs v-model="activeNewsTabName"  @tab-click="handleTabsOfNewsManagementClick" type="border-card" >
                            <!--轮播新闻-->
                ...
                <el-tab-pane label="审核进度" name="queryProgress">
                    <div style="padding-left: 10px;padding-top: 0;padding-right: 25px">

                        <!--里面再嵌套一个tabs组件，主要用于快捷查询处理审核流程中的新闻-->
        ...
        <!--新闻卡片 作用：1.向用户展示新闻在移动端的大致布局 2.创建新闻的入口-->
        <el-col :span="4" style="padding-top: 25px;padding-right: 25px" >
            <el-card  shadow="always" :body-style="{ padding: '0px' }">
                <!--主封面图 样式-->
                ...
                <!--跳转到新闻编辑页面-->
                <div @click="goAddNewsPage"><i class="el-icon-plus cover-icon">新建文章</i></div>
