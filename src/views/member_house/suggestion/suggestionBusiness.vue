    ...
    export default {
        ...
        methods: {
            ...
            getData(times,event) {
                ...
                setTimeout(() => {
                    this.$request.httpRequest({
                        method: 'get',
                        url: "/member_house/suggestion/suggestionBusiness",
                        noLoading: true,
                        params: {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        that.$request.httpRequest({
                            method: 'post',
                            url: "/member_house/suggestion/addOrUpdateSuggestionBusiness",
                            noLoading: true,
                            params: {
                                uid: that.form.uid,
                                name: that.form.name,
            ...
            changeStatus(row, status) {
                this.$request.httpRequest({
                    method: 'post',
                    url: "/member_house/suggestion/changeBusinessStatus",
                    noLoading: true,
                    params: {
                        uid: row.uid,
                        status: status
            ...
            changeSequence(row, type) {
                this.$request.httpRequest({
                    method: 'post',
                    url: "/member_house/suggestion/changeTypeSequence",
                    noLoading: true,
                    params: {
                        uid: row.uid,
                        type: type
            ...
            deleteType(row) {
                this.$confirm('确认删除该类型吗?', '提示', {
                    ...
                    this.$request.httpRequest({
                        method: 'delete',
                        url: "/member_house/suggestion/deleteSuggestionBusiness",
                        noLoading: true,
                        params: {
                            uid: row.uid
                        },
