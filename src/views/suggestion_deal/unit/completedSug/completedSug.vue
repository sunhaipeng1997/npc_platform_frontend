            ...
            <template v-if="$route.meta.check">
                ...
                <el-dialog title="建议详情" :visible.sync="showDetail" v-if="sugDetail.suggestion" width="45%">
                    ...
                    <el-row class="item-data">
                        <el-col :span="24">
                          <span><b>建议图片：</b>
                                ...
                                <div class="img-lsit" v-else v-for="(item,index) in sugDetail.suggestion.images"
                                     :key="index">
                                    <el-image
                                            class="image"
                  ...
                  <span><b>附议人：</b>
                                    ...
                                    <el-row class="item-data">
                                        <el-collapse accordion>
                                          ...
                                          <span><b>办理流程：</b>
                                              ...
                                              <el-timeline v-else>
                                                <el-timeline-item v-for="(process, index) in sugDetail.processes"
                                                                  :timestamp="process.handleTime" placement="top">
                                                  <el-card>
                                                    <div class="img-lsit" v-for="(img,index) in process.images"
                                                         :key="index">
                                            ...
                                            <el-collapse-item title="办理结果" name="2">
                                                <el-col :span="24">
                                                    <el-row class="item-data" v-if="sugDetail.result">
                                                        <el-col :span="24">
                                                            <span><b>结果说明：</b> {{sugDetail.result.result}}</span>
                                                        </el-col>
                                                    </el-row>
                                                    <el-row class="item-data">
                                                        <el-col :span="24">
                                                  <span><b>结果附件：</b>
                                                        <span v-if="!sugDetail.result.images">无</span>
                                                         <div v-else class="img-lsit"
                                                              v-for="(img,index) in sugDetail.result.images" :key="index">
                                                            <el-image class="image" :src="API.ServerUrl + img"
                    ...
                    <el-divider content-position="center" v-if="sugDetail.suggestion.resultVo"><h3>办理结果</h3></el-divider>
                    <el-row class="item-data" v-if="sugDetail.suggestion.resultVo">
                        <el-col :span="24">
                            <span><b>结果说明：</b> {{sugDetail.suggestion.resultVo.result}}</span>
                        </el-col>
                    </el-row>
                    <el-row class="item-data" v-if="sugDetail.suggestion.resultVo">
                        <el-col :span="24">
                    <span><b>结果附件：</b>
                          <span v-if="!sugDetail.suggestion.resultVo.images">无</span>
                           <div v-else class="img-lsit" v-for="(img,index) in sugDetail.suggestion.resultVo.images" :key="index">
                              <el-image class="image" :src="API.ServerUrl + img"
                                        :preview-src-list="imgPreview"></el-image>
                          </div>
                    </span>
                    ...
                    <el-divider content-position="center" v-if="sugDetail.suggestion.appraiseVo"><h3>评价</h3></el-divider>
                    <el-row class="item-data" v-if="sugDetail.suggestion.appraiseVo">
                        <el-col :span="12">
                            <el-row>
                                <el-col :span="6">
                                    <span><b>办理结果：</b></span>
                                ...
                                <el-col :span="12">
                                    <el-rate disabled="disabled" v-model="sugDetail.suggestion.appraiseVo.result"></el-rate>
                                </el-col>
                            </el-row>
                        </el-col>
                        <el-col :span="12">
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-rate disabled="disabled" v-model="sugDetail.suggestion.appraiseVo.attitude"></el-rate>
                                </el-col>
                            </el-row>
                        </el-col>
                    </el-row>
                    <el-row class="item-data" v-if="sugDetail.suggestion.appraiseVo">
                        <el-col :span="24">
                    <span><b>评价说明：</b>
                          <span>{{sugDetail.suggestion.appraiseVo.reason}}</span>
                    </span>
                        </el-col>
                    </el-row>
        ...
        methods: {
            ...
            getData(times) {
                ...
                setTimeout(() => {
                    this.$request.httpRequest({
                        method: 'get',
                        url: "/suggestion_deal/unit_suggestion/page_complete",
                        noLoading: true,
                        params: {
