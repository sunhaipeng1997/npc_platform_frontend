	...
	<div class="navbar">
		...
		<div class="right-menu">
			<el-dropdown class="avatar-container"
			             trigger="click"
			             @visible-change="triggerFlag=!triggerFlag">
				...
				<el-dropdown-menu slot="dropdown"
					...
					<el-dropdown-item>
						<span style="display:block;"
						      disabled
						      @click="backToGuide">退出系统</span>
					</el-dropdown-item>
					<el-dropdown-item>
						<span style="display:block;"
						      @click="logout">退出账户</span>
					</el-dropdown-item>
				</el-dropdown-menu>
			</el-dropdown>
		</div>
				...
				rules: {
					pass: [
						...
						},
						{
							...
							message: '以字母开头，长度在6~16之间，只能包含字母、数字和下划线'
						}],
					checkPass: [
						{
